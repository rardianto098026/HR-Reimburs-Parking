<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Export.aspx.vb" Inherits="HRReimbursParking.Frm_Export" %>
...
<body>
    <form id="form1" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td align ="right">
                                            <asp:CheckBox ID="CheckEntity1" runat="server" Text="" TextAlign=left />
                                        </td>
                                        <td align ="left" height="20px" class="style2">
                                            Entity <asp:Label ID="lblEntity1" runat="server" Text="." enabled="false" ForeColor="Red"></asp:Label>
                                        </td>
                                         <td align ="left" width="10px">
                                            :
                                        </td>
                                        <td width="75%"  align ="left">
                                            <asp:Dropdownlist ID="ddlEntity1" runat="server" CssClass="textbox" Width= "145px" >
                                            <asp:ListItem Text="--Choose--"></asp:ListItem> 
                                            <asp:ListItem Text="AAMI"></asp:ListItem> 
                                            <asp:ListItem Text="AFI"></asp:ListItem> 
                                            <asp:ListItem Text="ALI"></asp:ListItem> 
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td align ="right">
                                            <asp:CheckBox ID="Checkstat" runat="server" Text="" TextAlign="left" />
                                        </td>
                                        <td align ="left" height="20px" class="style2">
                                          Status <asp:Label ID="Label3" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                         <td align ="left" width="10px">
                                            :
                                        </td>
                                        <td width="75%"  align ="left">
                                            <asp:dropdownlist ID="ddlstatus" runat="server" CssClass="textbox" Width="145px">
                                                <asp:ListItem Text="--Choose--" Value=""></asp:ListItem>
                                                <asp:ListItem Text="Submit" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="Approve" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Reject" Value="2"></asp:ListItem>
                                            </asp:dropdownlist>
                                            &nbsp; <asp:Label ID="lblstat" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align ="right">
        ...
        <div style='height:200%;width:1200px;text-align:center;margin:0 auto';align="center" >
         <asp:gridview ID="dg_TRN_Reimburst2" runat="server" 
                            AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" 
                            BorderStyle="None" BorderWidth="1px" CellPadding="1" CssClass="tDatagridITReview" 
                            Height="100%" AllowSorting="True" PageSize="10" AllowPaging="true" OnRowCommand="dg_TRN_Reimburst2_RowCommand"
                            Width="1200px">
                         
                            <HeaderStyle CssClass="GridHeader" ForeColor="White" Font-Bold="True" HorizontalAlign="Center" />
                            <FooterStyle BackColor="White" ForeColor="#000066"/>
                            <Columns>	
                                    <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Preview">
                                    <ItemTemplate>
                               ...
                               <%-- <asp:BoundField  DataField="RangePeriod" HeaderText="Range Period" HeaderStyle-Width="100px" SortExpression="RangePeriod ASC" Visible="true">
                                ...
                                <asp:BoundField  DataField="Total_Amount_Approve" HeaderText="Total Amount Approved" HeaderStyle-Width="100px" SortExpression="Total_Amount_Approve ASC" Visible="true">
                                <HeaderStyle Width="100px"></HeaderStyle>
                                </asp:BoundField>
