<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_Reimbursment_Employee.aspx.vb" Inherits="HRReimbursParking.Frm_Reimbursment_Employee" %>
            ...
            <tr visible ="false">
             ...
             <tr>
                    ...
                    <td class="style3" align ="left">
                        ...
                        <asp:TextBox ID="txttotalday"  runat="server" style="margin-left: 30px" Width="141px" ></asp:TextBox>
                    </td>
                    <td background="Images/borderRight.gif" width="21" class="style2">
                        </td>
              </tr>
             ...
             <tr>
                    <td background="Images/borderleft.gif" width="21">
                        &nbsp;</td>
                    <td class="style1" height="30" align ="left">
                        Attach Invoice Document : <asp:FileUpload ID="txtUpload" runat="server" CssClass="textbox" Width="300px" Value="value"/> 
              ...
              <tr>
                    <td background="Images/borderleft.gif" width="21">
                        &nbsp;</td>
                    <td class="style1" height="30" align ="left">
                        Download : <asp:LinkButton ID="LinkDwn1" runat="server" STYLE="margin-left:75px" Visible="true"></asp:LinkButton>
