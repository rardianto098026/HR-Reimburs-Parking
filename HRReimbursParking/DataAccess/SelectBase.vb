...
#End Region
    Public Function f_CEK_DATE_FROM(ByVal EmpID As String, ByVal Datee As String, ByVal COMMAND As String, ByVal IDX As String) As DataTable
        ...
        oParam(2) = New SqlClient.SqlParameter("@COMMAND", SqlDbType.VarChar)
        oParam(2).Value = CType(COMMAND, String)
    ...
    End Function
    Public Function f_CEK_DATE_TO(ByVal EmpID As String, ByVal Datee As String, ByVal COMMAND As String, ByVal IDX As String) As DataTable
