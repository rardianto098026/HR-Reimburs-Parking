...
Public Class Frm_Reimbursment_Employee
    ...
    Sub cek_max_dateto()
        ...
        DT_CHECK = oSelect.f_CEK_DATE_TO(Session("EMPLNUMBER"), txtdateto.Text, "EDIT", Session("_idx").ToString)
    ...
    Sub cek_max_datefrom()
        Dim DT_CHECK As New DataTable
        DT_CHECK = oSelect.f_CEK_DATE_FROM(Session("EMPLNUMBER"), txtdatefrom.Text, "EDIT", Session("_idx").ToString)
