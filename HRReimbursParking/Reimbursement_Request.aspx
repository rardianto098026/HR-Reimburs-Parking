<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Reimbursement_Request.aspx.vb" Inherits="HRReimbursParking.Reimbursement_Request" %>
        ...
        <table width="1200px" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr visible ="false">
                    ...
                    <td class="style3" align ="left">
                        ...
                        <asp:TextBox ID="txttotalamount"  runat="server" style="margin-left: 30px" Width="141px" Enabled = "false"></asp:TextBox>
                    </td>
                    <td background="Images/borderRight.gif" width="21" class="style2">
                        </td>
              </tr>
             ...
             <tr>
                    ...
                    <td class="style3" align ="left">
                        <asp:Label ID="totaldays" runat="server" Text="Total Days:" width="100px" height="30px"></asp:Label>
