<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Frm_List_Reimbursment_Request_Admin.aspx.vb" Inherits="HRReimbursParking.Frm_List_Reimbursment_Request_Admin" %>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td align ="left" height="20px" class="style2">
                                            Entity <asp:Label ID="lblEntity1" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                         <td align ="left" width="10px">
                                            :
                                        </td>
                                        <td width="75%"  align ="left">
                                            <asp:Dropdownlist ID="ddlEntity1" runat="server" CssClass="textbox">
                                            <asp:ListItem Text="--Choose--"></asp:ListItem> 
                                            <asp:ListItem Text="AAMI"></asp:ListItem> 
                                            <asp:ListItem Text="AFI"></asp:ListItem> 
                                            <asp:ListItem Text="ALI"></asp:ListItem> 
                                            ...
                                            &nbsp; <asp:Label ID="Label2" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                    ...
                                    <%--<tr>
                                        <td align ="right">
                                            <asp:CheckBox ID="CheckRangePeriod" runat="server" Text="" TextAlign=left />
                                        </td>
                                        <td align ="left" height="20px" class="style2">
                                            Range Period <asp:Label ID="lblrangeperiod" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
                                         <td align ="left" width="10px">
                                            :
                                        </td>
                                        <td width="75%"  align ="left"> 
                                              <asp:DropDownList ID="ddlrangeperiod" runat="server" CssClass="textbox" >
                                              </asp:DropDownList>
                                            &nbsp; <asp:Label ID="lblrangeperiod2" runat="server" Text="." Visible="false" ForeColor="Red"></asp:Label>
                                        </td>
