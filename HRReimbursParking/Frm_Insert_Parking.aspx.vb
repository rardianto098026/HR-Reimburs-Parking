Public Partial Class Frm_Insert_Parking
    ...
    Sub LoadData()
        ...
        If dtSelect.Rows.Count > 0 Then
            ...
            Label25.Text = dtSelect.Rows(0)("SINGLEORDOUBLE_EXISTING").ToString()
    ...
    Public Function Submit() As String
        ...
        Try
            ...
            oUpdate.f_EDITDATA_PARKING(lblID2.Text, lblNamaKaryawan.Text, lblNoPolExisting.Text, lblTypeKendExisting.Text,
                                       ...
                                       lblNoPolExisting2.Text, ddlSingle.SelectedItem.Text, Label25.Text)

            oInsert.f_GET_BODY_EMAIL(lblNamaKaryawan.Text, lblID2.Text)
        ...
        Return rows
    End Function
    Protected Sub Alert(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click, btnSubmit.Click, btnSubmit.Click
