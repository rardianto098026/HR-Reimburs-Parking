...
Partial Public Class Menu
    ...
    Sub menu()
                ...
                For x As Integer = 1 To Jumlah
                    ...
                    If Not dtread.IsDBNull(dtread.GetOrdinal("UserName")) Then
                        ...
                        ElseIf jumlahMenu > 1 Then
                            ...
                            If MenuNameMaster = "Reimbursement Request" Then
                                mymenuM.Selectable = False
                                mymenuM.Enabled = True
                                mymenuM.ChildItems.Add(New MenuItem("Insert Reimbursement Request", "Frm_Reimbursment_Request", "", "~/Frm_Reimbursment_Request.aspx"))
                                mymenuM.ChildItems.Add(New MenuItem("List Reimbursement Request", "Frm_List_Reimbursment_Request", "", "~/Frm_List_Reimbursment_Request.aspx"))
        ...
        ElseIf dtx.Rows(0)("ROLE") = "USER"
            ...
            menuHome3.Text = "Reimbursement Request"
            menuHome3.Selectable = False
            menuHome3.Enabled = True
            menuHome3.ChildItems.Add(New MenuItem("Insert Reimbursement Request", "Frm_Reimbursment_Request", "", "~/Frm_Reimbursment_Request.aspx"))
            menuHome3.ChildItems.Add(New MenuItem("List Reimbursement Request", "Frm_List_Reimbursment_Request", "", "~/Frm_List_Reimbursment_Request.aspx"))
        End If
    End Sub
